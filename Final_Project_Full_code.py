...
class FirstPage:
  def __init__(self,master):
    ...
    self.pname= ttk.Label(self.window ,text = " Project Name",background="Light blue").grid(row = 0,column = 0)
    self.cname = ttk.Label(self.window ,text = "Client Name",background="Light blue").grid(row = 1,column = 0)
    self.dname = ttk.Label(self.window ,text = "Domain Name ",background="Light blue").grid(row = 2,column = 0)
    self.pname_field =Entry(self.window)
    self.pname_field.grid(row = 0,column = 1)
    self.cname_field =Entry(self.window)
    self.cname_field.grid(row = 1,column = 1)
    self.dname_field = Entry(self.window)
    self.dname_field.grid(row = 2,column = 1)
    self.btn = ttk.Button(self.window ,text="Next",command=self.insert).grid(row=3,column=1)
...
class SecondPage:
  def __init__(self,master):
    ...
    self.window.geometry('600x600')
    self.window.configure(background = "violet")
    self.cn = ttk.Label(self.window ,text = "No. of Cluster",background="Light blue").grid(row = 0,column = 0)
    self.f1= ttk.Label(self.window ,text = "Feature 1",background="Light blue").grid(row = 1,column = 0)
    self.f2 = ttk.Label(self.window ,text = "Feature 2",background="Light blue").grid(row = 2,column = 0)
    self.f3 = ttk.Label(self.window ,text = "Feature 3 ",background="Light blue").grid(row = 3,column = 0)
    self.s1= ttk.Label(self.window ,text = "Score 1",background="Light blue").grid(row = 1,column = 2)
    self.s2 = ttk.Label(self.window ,text = "Score 2",background="Light blue").grid(row = 2,column = 2)
    self.s3 = ttk.Label(self.window ,text = "Score 3",background="Light blue").grid(row = 3,column = 2)
    self.cn_field =Entry(self.window)
    self.cn_field.grid(row = 0,column = 1)    
    self.f1_field =Entry(self.window)
    self.f1_field.grid(row = 1,column = 1)
    self.f2_field =Entry(self.window)
    self.f2_field.grid(row = 2,column = 1)
    self.f3_field = Entry(self.window)
    self.f3_field.grid(row = 3,column = 1)
    self.s1_field =Entry(self.window)
    self.s1_field.grid(row = 1,column = 3)
    self.s2_field =Entry(self.window)
    self.s2_field.grid(row = 2,column = 3)
    self.s3_field = Entry(self.window)
    self.s3_field.grid(row = 3,column = 3)
    self.l = ttk.Label(self.window, text="Available Options are given below").grid(row= 5,column=0)
    self.l1 = ttk.Label(self.window ,text = "Experience||Total_project||Rating",background="Light blue").grid(row = 6,column = 0)
    self.l2 = ttk.Label(self.window ,text = "AI_project_count||ML_project_count||JS_project_count",background="Light blue").grid(row = 7,column = 0)
    self.l3 = ttk.Label(self.window ,text = "Java_project_count||DotNet_project_count||Mobile_project_count",background="Light blue").grid(row = 8,column = 0)    
    self.btn = ttk.Button(self.window ,text="Next",command=self.insert).grid(row=9,column=4)
...
class ThirdPage:
  def __init__(self,master):
    ...
    self.tt = ttk.Label(self.window,text="Enter SKills Required (Yes/No)").grid(row = 0,column= 1)
    self.python = ttk.Label(self.window,text="Python").grid(row = 1,column= 0)
    ...
    self.ml = ttk.Label(self.window,text="Machine Learning").grid(row = 2,column= 0)
    ...
    self.dl = ttk.Label(self.window,text="Deep Learning").grid(row = 3,column= 0)
    ...
    self.da = ttk.Label(self.window,text="Data Analysis").grid(row = 4,column= 0)
    ...
    self.asp = ttk.Label(self.window,text="ASP.Net").grid(row = 5,column= 0)
    ...
    self.ado = ttk.Label(self.window,text="ADO.Net").grid(row = 6,column= 0)
    ...
    self.vb = ttk.Label(self.window,text="VB.Net").grid(row = 7,column= 0)
    ...
    self.csharp = ttk.Label(self.window,text="c#").grid(row = 8,column= 0)
    ...
    self.java = ttk.Label(self.window,text="Java").grid(row = 9,column= 0)
    ...
    self.sb = ttk.Label(self.window,text="Spring Boot").grid(row = 10  ,column= 0)
    ...
    self.hb = ttk.Label(self.window,text="Hibernate").grid(row = 11,column= 0)
    ...
    self.nlp = ttk.Label(self.window,text="NLP").grid(row = 12,column= 0)
    ...
    self.cv = ttk.Label(self.window,text="CV").grid(row = 13,column= 0)
    ...
    self.js = ttk.Label(self.window,text="JS").grid(row = 14,column= 0)
    ...
    self.react = ttk.Label(self.window,text="React").grid(row = 15  ,column= 0)
    ...
    self.node = ttk.Label(self.window,text="Node").grid(row = 16,column= 0)
    ...
    self.angular = ttk.Label(self.window,text="Angular").grid(row = 17,column= 0)
    ...
    self.dart = ttk.Label(self.window,text="Dart").grid(row = 18,column= 0)
    ...
    self.flutter = ttk.Label(self.window,text="Flutter").grid(row = 19,column= 0)
...
class FourthPage:
  def __init__(self,master):
    ...
    self.l1 = ttk.Label(self.window, text = "Details").grid(row = 0, column = 1)
  
    self.l2 = ttk.Label(self.window, text = "Feature 1:").grid(column = 0,
    ...
    self.l2 = ttk.Label(self.window, text = "Feature 2:").grid(column = 0,
    ...
    self.l3 = ttk.Label(self.window, text = "Feature 3:").grid(column = 0,
    ...
    self.l4 = ttk.Label(self.window, text = "Feature 4:").grid(column = 0,
...
class FifthPage:
  def __init__(self,master):
    ...
    self.l = ttk.Label(self.window, text = "Processing Wait").grid(column = 1,
              row = 0)
    self.b1 = ttk.Button(self.window,text="calculate",command=self.calculate).grid(row = 5, column = 0)
    self.b2 = ttk.Button(self.window,text="Next",command=self.next).grid(row = 5, column = 1)
  def calculate(self):
...
class SixthPage:
  def __init__(self,master,data):
    ...
    self.window.geometry('600x600')
    self.l = ttk.Label(self.window, text = "Processing Wait").grid(column = 0,
              row = 0)
    self.b1 = ttk.Button(self.window,text="calculate",command=self.calculate).grid(row = 5, column = 3)
    self.b2 = ttk.Button(self.window,text="Next",command=self.next).grid(row = 5, column = 4)
  def calculate(self):
    ...
    for i in range(len(self.newdata)):
        ...
        self.l1 = ttk.Label(self.window, text = text_).grid(column = 0,row = i)
...
class EightPage:
  def __init__(self,master,data):
    ...
    print(len(self.data))
    self.b1 = ttk.Button(self.window,text="calculate",command=self.calculate).grid(row = 5, column = 3)
    self.b2 = ttk.Button(self.window,text="Close",command=self.close).grid(row = 5, column = 4)    
  def calculate(self):
    self.dm  = DesignationMatching(self.data)
    self.dm.assign_priority()
    self.str_ = self.dm.designation_matching()
    self.l = ttk.Label(self.window, text = self.str_).grid(column = 0,
              row = 0)    
  def close(self):
      self.window.destroy()
